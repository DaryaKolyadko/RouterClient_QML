...
void WifiDataParser::pushToParamsList(WifiInfoParseResult& res, QStringList list, int count)
{
...
int WifiDataParser::combineRateStr(QStringList &list)
{
...
void WifiDataParser::combineSsid(QStringList &list, int beginIndex, int ssidLength)
{
    if (ssidLength > 0)
    {
...
void WifiDataParser::deleteConnectMark(QStringList &list)
{
...
QList<int> WifiDataParser::findAllConnectedIndexes(QStringList list)
{
    QList<int> indexes;
